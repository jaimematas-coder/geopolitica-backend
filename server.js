...
async function analizarYEnviar(titulares) {
  ...
  var red;
  try {
    red = await callClaude(
      "Eres analista geopolitico senior especializado en MENA. JSON valido unicamente.",
      "Redacta estas noticias para un canal de divulgacion geopolitica.\n\n" +
      "NORMAS ESTRICTAS:\n" +
      "- Solo hechos que aparezcan EXPLICITAMENTE en el contenido del articulo. Cero conocimiento externo.\n" +
      "- Si citas un dato (cifra, nombre, acuerdo), debe estar literalmente en el contenido.\n" +
      "- Las fuentes son EXACTAMENTE las proporcionadas. No inventes ni añadas otras.\n" +
      "- Prioriza la triangulacion: si hay contradicciones entre fuentes, indicalo.\n" +
      "- Bloque extra: solo si el contenido aporta >= 2 puntos concretos adicionales no incluidos en el texto. Maximo 3 puntos, una frase cada uno.\n" +
      "- Tipos bloque extra: claves, analisis, actores, contexto.\n\n" +
      "CAMPO 'texto': 2-3 frases directas sin titular. Neutro, informativo, sin valoraciones.\n" +
      "CAMPO 'banderas': emojis de banderas de paises protagonistas (max 3).\n" +
      "CAMPO 'titular': titular interno breve en espanol.\n\n" +
      "Articulos:\n" + articulosStr + "\n\n" +
      "{\"noticias\":[{\"titulo_original\":\"exacto\",\"titular\":\"espanol breve\",\"banderas\":\"🇮🇷 🇺🇸\",\"texto\":\"2-3 frases directas\",\"analisis\":\"implicaciones basadas en el contenido\",\"triangulacion\":{\"fuentes\":[\"medio1\",\"medio2\"],\"contradicciones\":\"\"},\"extra\":{\"tipo\":\"claves\",\"contenido\":\"\"}}]}"
    );
    console.log("Claude paso 2 completado: " + (red.noticias || []).length + " noticias");
  } catch (e) {
    console.error("Claude paso 2 FAILED: " + e.message);
    return;
  }
