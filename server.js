...
async function analizarYEnviar(titulares) {
  ...
  var red = await callClaude(
    "Eres analista geopolitico senior especializado en MENA. JSON valido unicamente.",
    "Redacta estas noticias para Instagram basandote UNICAMENTE en el contenido real de los articulos proporcionados.\n" +
    "NORMAS ESTRICTAS:\n" +
    ...
    "- Si el contenido no esta disponible (paywall), indicalo en el analisis y basa el texto solo en el titular.\n" +
    "- Las fuentes son exactamente las proporcionadas en cada articulo. No añadas ni inventes otras.\n" +
    ...
    "Articulos:\n" + articulosStr + "\n\n" +
    "{\"noticias\":[{\"titulo_original\":\"exacto\",\"titular\":\"espanol\",\"texto\":\"2-3 frases basadas en el contenido real\",\"analisis\":\"implicaciones geopoliticas basadas en el contenido\",\"triangulacion\":{\"fuentes\":[\"medio1\"],\"contradicciones\":\"\"},\"extra\":{\"tipo\":\"claves\",\"contenido\":\"\"}}]}"
  );
