...
async function analizarYEnviar(titulares) {
  ...
  var sel = await callClaude(
    ...
    "Titulares:\n" + resumen + "\n\n" +
    "Selecciona 2-4 noticias importantes. Si no hay nada relevante devuelve array vacio. MENA>=6, Global>=8.\n" +
    "CRITICO: Para cada noticia seleccionada, incluye en 'fuentes' UNICAMENTE los titulares de esta lista que traten EXACTAMENTE el mismo hecho. No añadas fuentes que traten temas relacionados pero distintos. Si solo un titular cubre ese hecho, pon solo esa fuente.\n" +
